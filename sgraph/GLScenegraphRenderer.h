...
namespace sgraph {
    ...
    class GLScenegraphRenderer: public SGNodeVisitor {
         ...
         */
        GLScenegraphRenderer(stack<glm::mat4>& mv,map<string,util::ObjectInstance *>& os,map<string,unsigned int>ti,util::ShaderLocationsVault& shaderLocations) 
            : modelview(mv)
            , objects(os)
            , textureIds(ti) {
        ...
        void visitLeafNode(LeafNode *leafNode) {
            ...
            glUniformMatrix4fv(shaderLocations.getLocation("texturematrix"), 1, false,glm::value_ptr(glm::mat4(1.0)));
            ...
            std::string textureName = leafNode->getTextureName();
