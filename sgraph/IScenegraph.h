 ...
 */
   ...
   /**
     ...
     */
      ...
      /**
       * Set the texture name ->texture for all textures used by this scene graph
       * 
       * @param textures
       */
        virtual void setTextures(map<string,util::TextureImage*>& textures)=0;
      ...
      /**
       * get the textures used by this scene graph
       * 
       * @return map<string,util::TextureImage> 
       */
        virtual map<string,util::TextureImage*> getTextures()=0;
    };
}
